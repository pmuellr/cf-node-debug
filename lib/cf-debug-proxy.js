...
(function() {
  var PORT_DEBUG, PORT_PROXY, PORT_TARGET, PORT_V8, PRE_D, PRE_P, PRE_T, ProxyDebug, ProxyTarget, URL_DEBUG, URL_TARGET, appEnv, cfenv, child_process, http, httpProxy, kill, path, q, startDebugger, startProxy, startTarget, utils, websocket, _,
    __slice = [].slice;
